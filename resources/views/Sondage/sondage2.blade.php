    ...
    <div class="card" style="width: 22rem;">
      <div class="card-body">
        ...
        <div class="list-group list-group-checkable d-grid gap-2 border-0 w-75">
          <input class="list-group-item-check pe-none" type="radio" name="choix1" id="choix1-1" value="web" checked>
          ...
          <input class="list-group-item-check pe-none" type="radio" name="choix1" id="choix1-2" value="mobile">
      ...
      <div class="card-body">
        ...
        <div class="list-group list-group-radio d-grid gap-2 border-0 w-75">
          <div class="position-relative">
            <input class="form-check-input position-absolute top-50 end-0 me-3 fs-5" type="radio" name="choix2" id="choix2-1" value="web">
          ...
          <div class="position-relative">
            <input class="form-check-input position-absolute top-50 end-0 me-3 fs-5" type="radio" name="choix2" id="choix2-2" value="mobile">
      ...
      <div class="card-body">
        ...
        <div class="list-group w-75">
          <label class="list-group-item d-flex gap-2">
            <input class="form-check-input flex-shrink-0" type="radio" name="choix3" id="choix3-1" value="web">
            <span>
              Développement Web
          ...
          <br>
          <label class="list-group-item d-flex gap-2">
            <input class="form-check-input flex-shrink-0" type="radio" name="choix3" id="choix3-2" value="mobile">
            <span>
              Développement Mobile
